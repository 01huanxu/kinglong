...
_HMIGRPCSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='TriggerPlayRecord',
    full_name='adu.hmi.HMIGrpcService.TriggerPlayRecord',
    index=25,
    containing_service=None,
    input_type=hmi__car__device__pb2._TRIGGERREQUEST,
    output_type=hmi__common__pb2._STATUSRESPONSE,
  ...
  _descriptor.MethodDescriptor(
    ...
    index=29,
    containing_service=None,
    input_type=hmi__collect__data__pb2._WORKSTATEREQUEST,
    output_type=hmi__common__pb2._STATUSRESPONSE,
    options=None,
  ),
  _descriptor.MethodDescriptor(
  ...
  _descriptor.MethodDescriptor(
    name='NotiHeartBeat',
    full_name='adu.hmi.HMIGrpcService.NotiHeartBeat',
    index=31,
    containing_service=None,
    input_type=hmi__world__pb2._HEARTBEATTYPE,
    output_type=hmi__common__pb2._STATUSRESPONSE,
    options=None,
  ),
  _descriptor.MethodDescriptor(
