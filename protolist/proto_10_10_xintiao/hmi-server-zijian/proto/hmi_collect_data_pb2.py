...
_WORKSTATEREQUEST = _descriptor.Descriptor(
  name='WorkStateRequest',
  full_name='adu.hmi.WorkStateRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='car_work_mode', full_name='adu.hmi.WorkStateRequest.car_work_mode', index=0,
...
_WORKSTATERESULT = _descriptor.Descriptor(
  name='WorkStateResult',
  full_name='adu.hmi.WorkStateResult',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='code', full_name='adu.hmi.WorkStateResult.code', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='car_work_mode', full_name='adu.hmi.WorkStateResult.car_work_mode', index=1,
...
_WORKSTATEREQUEST.fields_by_name['car_work_mode'].enum_type = _CARWORKMODE
_GLOBALWORKMODE.fields_by_name['car_work_mode'].enum_type = _CARWORKMODE
_WORKSTATERESULT.fields_by_name['code'].enum_type = hmi__error__code__pb2._ERRORCODE
_WORKSTATERESULT.fields_by_name['car_work_mode'].enum_type = _CARWORKMODE
...
DESCRIPTOR.message_types_by_name['WorkStateRequest'] = _WORKSTATEREQUEST
DESCRIPTOR.message_types_by_name['GlobalWorkMode'] = _GLOBALWORKMODE
DESCRIPTOR.message_types_by_name['WorkStateResult'] = _WORKSTATERESULT
...
WorkStateRequest = _reflection.GeneratedProtocolMessageType('WorkStateRequest', (_message.Message,), dict(
  DESCRIPTOR = _WORKSTATEREQUEST,
  __module__ = 'hmi_collect_data_pb2'
  # @@protoc_insertion_point(class_scope:adu.hmi.WorkStateRequest)
  ))
_sym_db.RegisterMessage(WorkStateRequest)
...
WorkStateResult = _reflection.GeneratedProtocolMessageType('WorkStateResult', (_message.Message,), dict(
  DESCRIPTOR = _WORKSTATERESULT,
  __module__ = 'hmi_collect_data_pb2'
  # @@protoc_insertion_point(class_scope:adu.hmi.WorkStateResult)
  ))
_sym_db.RegisterMessage(WorkStateResult)
